---
layout: post
title: "MXFckup: How Email Falls Over in Three Easy TXT Records"
date: 2025-09-17 10:20:00 +0100
categories: email dns mx spf dmarc bimi recon
permalink: /mxfckup/
---

*Featuring misdirected parcels, TXT spaghetti, and a BIMI logo that looks like it was faxed in 2009.*
...
Meet Max. Max forwards mail like a champion… until you move the post office and forget to tell the lorries. Email is just the postal service with worse uniforms; MX records are sorting centers, SPF/DMARC are the rules about who’s allowed to drop parcels at the back door, and BIMI is the big friendly logo on the building. `mxfckup` does a flyover and tells you which bits are on fire.
...
If you’re doing it by hand because you love pain (relatable):
...
SPF include chains are where good intentions go to nap. Here’s a tiny helper to count depth:
...
STARTTLS sanity (don’t be loud; one probe is enough):
...
What `mxfckup` flags in plain English:
...
Email is 80% etiquette and 20% DNS. Fix the TXT spaghetti, point the vans to real buildings, and maybe—just maybe—your BIMI logo will stop looking like it was drawn in MS Paint by a raccoon.
